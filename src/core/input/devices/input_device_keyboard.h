...
public:
	...
	KeyboardDevice(u8 deviceId, Category category)
		: InputDevice(deviceId, category)
	{
		m_category = Category::KEYBOARD;
	}

	virtual u8 GetButtonsCount() const override { return buttonCount; }

	virtual u8 GetAxisCount() const override { return 0; };

private:
	static const u8 buttonCount = 197;
};
